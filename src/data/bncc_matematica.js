// --- DOCUMENTAÇÃO: BANCO DE DADOS DE MATEMÁTICA ---
const BANCO_BNCC = {
  ...
  EF06MA13:
    "Resolver e elaborar problemas que envolvam porcentagens, com base na ideia de proporcionalidade, sem fazer uso da “regra de três”, utilizando estratégias pessoais, cálculo mental e calculadora, em contextos de educação financeira, entre outros. HABILIDADES",
  EF06MA14:
  ...
  EF06MA15:
    "Resolver e elaborar problemas que envolvam a partilha de uma quantidade em duas partes desiguais, envolvendo relações aditivas e multiplicativas, bem como a razão entre as partes e entre uma das partes e o todo. HABILIDADES",
  EF06MA16:
  ...
  EF06MA23:
    "Construir algoritmo para resolver situações passo a passo (como na construção de dobraduras ou na indicação de deslocamento de um objeto no plano segundo pontos de referência e distâncias fornecidas etc.). HABILIDADES",
  EF06MA24:
  ...
  EF06MA29:
    "Analisar e descrever mudanças que ocorrem no perímetro e na área de um quadrado ao se ampliarem ou reduzirem, igualmente, as medidas de seus lados, para compreender que o perímetro é proporcional à medida do lado, o que não ocorre com a área. HABILIDADES",
  EF06MA30:
  ...
  EF07MA12:
    "Resolver e elaborar problemas que envolvam as operações com números racionais. HABILIDADES",
  EF07MA13:
  ...
  EF07MA18:
    "Resolver e elaborar problemas que possam ser representados por equações polinomiais de 1º grau, redutíveis à forma ax + b = c, fazendo uso das propriedades da igualdade HABILIDADES",
  EF07MA19:
  ...
  EF07MA20:
    "Reconhecer e representar, no plano cartesiano, o simétrico de figuras em relação aos eixos e à origem. Reconhecer e construir figuras obtidas por simetrias de translação, rotação e reflexão, usando instrumentos de desenho ou softwares de geometria dinâmica e vincular esse estudo a representações planas de obras de arte, elementos arquitetônicos, entre outros.",
  EF07MA22:
  ...
  EF07MA28:
    "Descrever, por escrito e por meio de um fluxograma, um algoritmo para a construção de um polígono regular (como quadrado e triângulo equilátero), conhecida a medida de seu lado. HABILIDADES",
  EF07MA29:
  ...
  EF07MA33:
    "Estabelecer o número como a razão entre a medida de uma circunferência e seu diâmetro, para compreender e resolver problemas, inclusive os de natureza histórica. HABILIDADES",
  EF07MA34:
  ...
  EF08MA05:
    "Reconhecer e utilizar procedimentos para a obtenção de uma fração geratriz para uma dízima periódica. HABILIDADES",
  EF08MA06:
  ...
  EF08MA13:
    "Resolver e elaborar problemas que envolvam grandezas diretamente ou inversamente proporcionais, por meio de estratégias variadas. HABILIDADES",
  EF08MA14:
  ...
  EF08MA18:
    "Reconhecer e construir figuras obtidas por composições de transformações geométricas (translação, reflexão e rotação), com o uso de instrumentos de desenho ou de softwares de geometria dinâmica. HABILIDADES",
  EF08MA19:
  ...
  EF08MA21:
    "Resolver e elaborar problemas que envolvam o cálculo do volume de recipiente cujo formato é o de um bloco retangular. HABILIDADES",
  EF08MA22:
  ...
  EF09MA05:
    "Resolver e elaborar problemas que envolvam porcentagens, com a ideia de aplicação de percentuais sucessivos e a determinação das taxas percentuais, preferencialmente com o uso de tecnologias digitais, no contexto da educação financeira. HABILIDADES",
  EF09MA06:
  ...
  EF09MA09:
    "Compreender os processos de fatoração de expressões algébricas, com base em suas relações com os produtos notáveis, para resolver e elaborar problemas que possam ser representados por equações polinomiais do 2º grau. HABILIDADES",
  EF09MA10:
  ...
  EF09MA17:
    "Reconhecer vistas ortogonais de figuras espaciais e aplicar esse conhecimento para desenhar objetos em perspectiva. HABILIDADES",
  EF09MA18:
  ...
  EF09MA23:
    "Planejar e executar pesquisa amostral envolvendo tema da realidade social e e da amplitude, tabelas e gráficos adequados, construídos com o apoio de planilhas eletrônicas.",
  ...
  EM13MAT105:
    "Utilizar as noções de transformações isométricas (translação, reflexão, rotação e composições destas) e transformações homotéticas para analisar diferentes produções humanas como construções civis, obras de arte, entre outras.",

  // COMPETÊNCIA ESPECÍFICA 2
  EM13MAT201:
    "Propor ações comunitárias, como as voltadas aos locais de moradia dos estudantes dentre outras, envolvendo cálculos das medidas de área, de volume, de capacidade ou de massa, adequados às demandas da região.",
  EM13MAT202:
  ...
  EM13MAT301:
    "Resolver e elaborar problemas do cotidiano, da Matemática e de outras áreas do conhecimento, que envolvem equações lineares simultâneas, usando técnicas algébricas e gráficas, incluindo ou não tecnologias digitais.",
  EM13MAT302:
    "Resolver e elaborar problemas cujos modelos são as funções polinomiais de 1º e 2º graus, em contextos diversos, incluindo ou não tecnologias digitais.",
  EM13MAT303:
    "Resolver e elaborar problemas envolvendo porcentagens em diversos contextos e sobre juros compostos, destacando o crescimento exponencial.",
  EM13MAT304:
  ...
  EM13MAT305:
    "Resolver e elaborar problemas com funções logarítmicas nos quais é necessário compreender e interpretar a variação das grandezas envolvidas, em contextos como os de abalos sísmicos, pH, radioatividade, Matemática Financeira, entre outros.",
  EM13MAT306:
    "Resolver e elaborar problemas em contextos que envolvem fenômenos periódicos reais, como ondas sonoras, ciclos menstruais, movimentos cíclicos, entre outros, e comparar suas representações com as funções seno e cosseno, no plano cartesiano, com ou sem apoio de aplicativos de álgebra e geometria.",
  EM13MAT307:
    "Empregar diferentes métodos para a obtenção da medida da área de uma superfície (reconfigurações, aproximação por cortes etc.) e deduzir expressões de cálculo para aplicá-las em situações reais, como o remanejamento e a distribuição de plantações, com ou sem apoio de tecnologias digitais.",
  EM13MAT308:
    "Resolver e elaborar problemas em variados contextos, envolvendo triângulos nos quais se aplicam as relações métricas ou as noções de congruência e semelhança.",
  EM13MAT309:
    "Resolver e elaborar problemas que envolvem o cálculo de áreas totais e de volumes de prismas, pirâmides e corpos redondos (cilindro e cone) em situações reais, como o cálculo do gasto de material para forrações ou pinturas de objetos cujos formatos sejam composições dos sólidos estudados.",
  EM13MAT310:
  ...
  EM13MAT311:
    "Resolver e elaborar problemas que envolvem o cálculo da probabilidade de eventos aleatórios, identificando e descrevendo o espaço amostral e realizando contagem das possibilidades.",
  EM13MAT312:
    "Resolver e elaborar problemas que envolvem o cálculo de probabilidade de eventos em experimentos aleatórios sucessivos.",
  EM13MAT313:
    "Resolver e elaborar problemas que envolvem medições em que se discuta o emprego de algarismos significativos e algarismos duvidosos, utilizando, quando necessário, a notação científica.",
  EM13MAT314:
    "Resolver e elaborar problemas que envolvem grandezas compostas, determinadas pela razão ou pelo produto de duas outras, como velocidade, densidade demográfica, energia elétrica etc.",
  EM13MAT315:
  ...
  EM13MAT401:
    "Converter representações algébricas de funções polinomiais de 1º grau para representações geométricas no plano cartesiano, distinguindo os casos nos quais o comportamento é proporcional, recorrendo ou não a softwares ou aplicativos de álgebra e geometria dinâmica.",
  EM13MAT402:
    "Converter representações algébricas de funções polinomiais de 2º grau para representações geométricas no plano cartesiano, distinguindo os casos nos quais uma variável for diretamente proporcional ao quadrado da outra, recorrendo ou não a softwares ou aplicativos de álgebra e geometria dinâmica.",
  EM13MAT403:
  ...
  EM13MAT405:
    "Reconhecer funções definidas por uma ou mais sentenças (como a tabela do Imposto de Renda, contas de luz, água, gás etc.), em suas representações algébrica e gráfica, convertendo essas representações de uma para outra e identificando domínios de validade, imagem, crescimento e decrescimento.",
  EM13MAT406:
  ...
  EM13MAT407:
    "Interpretar e construir vistas ortogonais de uma figura espacial para representar formas tridimensionais por meio de figuras planas.",
  EM13MAT408:
  ...
  EM13MAT409:
    "Interpretar e comparar conjuntos de dados estatísticos por meio de diferentes diagramas e gráficos, como o histograma, o de caixa (box-plot), o de ramos e folhas, reconhecendo os mais eficientes para sua análise.",
  ...
  EM13MAT503:
    "Investigar pontos de máximo ou de mínimo de funções quadráticas em contextos da Matemática Financeira ou da Cinemática, entre outros.",
  EM13MAT504:
  ...
  EM13MAT505:
    "Resolver problemas sobre ladrilhamentos do plano, com ou sem apoio de aplicativos de geometria dinâmica, para conjecturar a respeito dos tipos ou composição de polígonos que podem ser utilizados, generalizando padrões observados.",
  EM13MAT506:
  ...
  EM13MAT511:
    "Reconhecer a existência de diferentes tipos de espaços amostrais, discretos ou não, de eventos equiprováveis ou não, e investigar as implicações no cálculo de probabilidades.",
  EM13MAT512:
